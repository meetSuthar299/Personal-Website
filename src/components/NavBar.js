                    ...
                    <div class="ml-auto lg:hidden">
                        ...
                        {isMenuOpen && (
                            <div class="absolute top-0 left-0 w-full">
                                <div class="p-5 shadow-md bg-[rgba(0,0,0,0.9)] backdrop-blur-lg rounded-md">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <div className="justify-end">
                                            <button
                                                ...
                                                title="Close Menu"
                                                class="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-500 focus:bg-gray-900 focus:outline-none focus:shadow-outline"
